...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','TiXPath.js')
	...
	f = os.path.join(cwd,'Classes','TiXPathModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','TiXPath.js']
